...
%podlogowka test
% kp_zaw_podloga = -136039.74;
% ki_zaw_podloga = -43.2016;
% kp_zaw_podloga = -59326.0324;
% ki_zaw_podloga = -0.02772;

% kp_zaw_podloga = -157428.0727;
% ki_zaw_podloga = -6.8784;
...
model = "sim_instalacja_podlogowa_regulacja_pokojowa.slx";

sim(model,czas);
figure(1);
plot(ans.tout(100100:110000),ans.Twew(100100:110000),'c'),hold on, grid on;

figure(2);
plot(ans.tout(100100:110000),ans.Tcwu(100100:110000),'c'),hold on, grid on;

figure(3);
plot(ans.tout(100100:110000),ans.Tkz(100100:110000),'c'),hold on, grid on;
